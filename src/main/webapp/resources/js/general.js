...
//sidebar accordion
	...
	if( $(".accordionSide").length){
	   $('.accordionSide .accordDetail').hide();
	   $('.accordionSide .accTrigger').click(function(){
		  if ($(this).hasClass('active')) {
			   $('.accTrigger.active .fa-angle-right').removeClass('rotate90');
			   $(this).removeClass('active');
			   $(this).next().slideUp();
		  } else {
			  if ($('body').hasClass('desktop')) {
			   $('.accordionSide .accTrigger').removeClass('active');
			   $('.accordionSide .accordDetail').slideUp();
			   $('.accTrigger .fa-angle-right').removeClass('rotate90');
			  }
			   $(this).addClass('active');
			    $('.accTrigger.active .fa-angle-right').addClass('rotate90');		
			   $(this).next().slideDown();
		  }
		  return false;
	   });
    ...
    $("#search").click(function(){
		$( "#searchOpen").toggle( "slide",{direction:'right'});
    });
...
//side btn
    ...
    $(".sidebar").toggle("slide",{direction:'left'});
	    ...
	    $( ".sidebar" ).animate({left: "0"}, 400, function() {});
		  $(".sidebar").addClass('posAbs');
		  $(this).removeClass('hide').addClass('show');
		  $(".fullWidth").addClass('width80').removeClass('width100');
        }
        else {   	
	    $( ".sidebar" ).animate({left: "-20%"}, 400, function() {});
		  $(".sidebar").addClass('posAbs');
		  $(this).removeClass('show').addClass('hide');
		  $(".fullWidth").addClass('width100').removeClass('width80');
        }
    });
	...
	$(window).on('resize', function () {
		...
		$('.fullWidth').resize(function(){slideBarHeight()});
		$('#middle').resize(function(){slideBarHeight()});
		
		$('.centerPosition').css({
        'position' : 'absolute',
        'left' : '50%',
        'top' : '50%',
        'margin-left' : -$('.centerPosition').outerWidth()/2,
        'margin-top' : -$('.centerPosition').outerHeight()/2
    });
...
function slideBarHeight () {	
	...
	var sidebarH = $(window).outerHeight() - $(".header").height();
	var containerH = $(".fullWidth").outerHeight()

	if (containerH > sidebarH) { minHeight = containerH;  }else {minHeight = sidebarH;  } 
